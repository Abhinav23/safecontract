$(window).load(function() {
    ...
    (function() {
        ...
        MESSAGES.push({
            delay: 800,
            text: ' —  Ethereum Based Decentralized Application;'
        });
        MESSAGES.push({
            delay: 1800,
            text: ' —  Stores Your Cryptoassets For Extended Periods Of Time;'
        });
        MESSAGES.push({
            delay: 3200,
            text: ' —  Enabling Users To Be Their Own Bank Using Safecontract.'
        });
        MESSAGES.push({
            delay: 4800,
            text: ' '
